...
const SelectionComponent = ({
  ...
  return (
    <div
      className="flex w-[105px] cursor-pointer items-center justify-center rounded-md border border-gray-300 py-1.5 shadow-sm hover:border-gray-500 hover:bg-gray-100"
      onClick={onClick}
...
export const FontFamilySlectionCSR = dynamic(
  () => Promise.resolve(FontFamilySlections),
  {
    ssr: false,
  }
);
          ...
          >
            <div className="flex flex-col items-center">
              ...
              <div className="text-sm">
                {type === "Letter" ?"(Us,Canadian)" : "Other Countries"}
              </div>
            </div>
          </SelectionComponent>
        );
